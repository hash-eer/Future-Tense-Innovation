      ...
      >
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-7xl mx-auto">
            ...
            {/* Column Titles */}
            <div className="grid grid-cols-3 text-yellow-400 font-semibold text-center mb-2 px-4">
            ...
            <div className="flex flex-col gap-6">
              {product.map((item, index) => (
                <div
                  key={index}
                  className="grid grid-cols-3 items-center bg-gray-800/95 hover:bg-gray-700/95 transition-all duration-300 rounded-lg backdrop-blur-sm border border-gray-700/50 hover:border-blue-500/50 hover:shadow-xl hover:shadow-blue-500/20 p-4"
                >
                  {/* Manufacturer Image */}
                  <div className="flex justify-center items-center">
                    <img
                      src={item.manufacturerImg}
